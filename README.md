...
[![npm core](https://img.shields.io/npm/v/@iplex/aicut-core?label=%40aicut%2Fcore&style=flat-square&logo=npm&color=cb3837)](https://www.npmjs.com/package/@iplex/aicut-core)
[![npm react](https://img.shields.io/npm/v/@iplex/aicut-react?label=%40aicut%2Freact&style=flat-square&logo=react&color=149eca)](https://www.npmjs.com/package/@iplex/aicut-react)
[![npm vue](https://img.shields.io/npm/v/@iplex/aicut-vue?label=%40aicut%2Fvue&style=flat-square&logo=vuedotjs&color=42b883)](https://www.npmjs.com/package/@iplex/aicut-vue)
[![License](https://img.shields.io/npm/l/@iplex/aicut-core?style=flat-square&color=4c1)](./LICENSE)
...
<table>
  <tr>
    <td>🧠</td><td><b>One engine, multiple frontends</b><br/><code>@iplex/aicut-core</code> does all the work; the React / Vue wrappers are &lt;100&nbsp;LOC shells. Same shape as ag-Grid.</td>
  </tr>
  <tr>
...
```ts
import { Editor } from "@iplex/aicut-core";
import "@iplex/aicut-core/styles.css";
...
For local dev, copy [`examples/react-demo/.env.example`](./examples/react-demo/.env.example) to `.env.local` and fill in. Without an `.env.local` the demo defaults to `http://127.0.0.1:8787` (TS) and `http://127.0.0.1:8788` (Go) — start either backend with `pnpm --filter @iplex/backend-ts dev` (or `--filter @iplex/backend-go`) and exports just work.
...
- [x] 3D lighting picker (`@iplex/aicut-core/lighting` sub-entry)
- [x] Pluggable `PlaybackEngine` interface (HTML5 default, host can inject)
- [x] WebCodecs preview engine for frame-accurate seek (`@iplex/aicut-core/webcodecs`, PoC: single-track MP4)
...
**[npm — @iplex/aicut-core](https://www.npmjs.com/package/@iplex/aicut-core)** ·
**[@iplex/aicut-react](https://www.npmjs.com/package/@iplex/aicut-react)** ·
**[@iplex/aicut-vue](https://www.npmjs.com/package/@iplex/aicut-vue)** ·
